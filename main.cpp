...
int main()
{
	...
	IrrlichtDevice* device = createDevice(	driverType,
											core::dimension2d<u32>(_WINDOW_WIDTH_, _WINDOW_HEIGHT_), 
	...
	scene::ICameraSceneNode* camera=smgr->addCameraSceneNode(	NULL,
																core::vector3df(offsety+50.f,100.f,offsetx),
	...
	while(device->run())
	{
		...
		This will typically NOT include collision
		detection with surrounding walls---that will be done later. */
